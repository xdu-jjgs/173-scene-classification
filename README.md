...
```shell
python tools/dataset/vnr_msi/assemble.py D:/dataset/VNR_Raw/output_MATLAB --path D:/dataset/VNR_Raw/output_assemble --class-list building factory farmland river
```
