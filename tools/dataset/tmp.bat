...
python test_hh.py runs/sar_msi_5000_average_0,6,8,10,15,16/resnet18_ce-train/config.yaml ^
        runs/sar_msi_5000_average_0,6,8,10,15,16/resnet18_ce-train/best.pth ^
        --path runs/sar_msi_5000_average_0,6,8,10,15,16/resnet18_ce-test-best_hh ^
        --device cuda:0
python test_hh.py runs/sar_msi_5000_average_0,6,8,10,15,16/resnet18_ce-train/config.yaml ^
        runs/sar_msi_5000_average_0,6,8,10,15,16/resnet18_ce-train/best.pth ^
        --path runs/sar_msi_5000_average_0,6,8,10,15,16/resnet18_ce-test-best_hh ^
