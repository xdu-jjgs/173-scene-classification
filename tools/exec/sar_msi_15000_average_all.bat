...
rem ResNet18
python train/classifier/train.py configs/sar_msi_15000_average_all/resnet18_ce.yaml ^
        --path runs/sar_msi_15000_average_all/resnet18_ce-train ^
        --nodes 1 ^
        --gpus 1 ^
        --rank-node 0 ^
        --backend gloo ^
...
python test.py runs/sar_msi_15000_average_all/resnet18_ce-train/config.yaml ^
        runs/sar_msi_15000_average_all/resnet18_ce-train/last.pth ^
        --path runs/sar_msi_15000_average_all/resnet18_ce-test-last ^
        --device cuda:0

python test.py runs/sar_msi_15000_average_all/resnet18_ce-train/config.yaml ^
        runs/sar_msi_15000_average_all/resnet18_ce-train/best.pth ^
        --path runs/sar_msi_15000_average_all/resnet18_ce-test-best ^
        --device cuda:0
